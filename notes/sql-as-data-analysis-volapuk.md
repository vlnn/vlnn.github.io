...
But, being widely used, SQL get into the fields, where I was surprised to see it – for instance in the NoSQL world. Check out how similar is Cassandra's CQL, even though Cassandra is famous NoSQL DB! Excel files [could be used as SQL data bases](https://docs.microsoft.com/en-us/power-automate/desktop-flows/how-to/sql-queries-excel)! Even very non-usual languages like Q are calling the some data-manipulating functions [q-sql](https://code.kx.com/q4m3/9_Queries_q-sql/), using different syntax, but at least partially sharing same mental model of the data manipulation.
