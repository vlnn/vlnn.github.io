...
Try K yourself here: [[https://johnearnest.github.io/ok/index.html][oK]] or [[https://kparc.io/kc][shakti k console]] (with oldschool reference at [[https://ref.kparc.io/#scan][ref k]])
...
Don't forget about the [[https://www.jsoftware.com/ioj/iojATW.htm][Incunabulum]]. Don't forget that [[jsoftware.com][jsoftware]] was not that different and provided closed-sourced binaries for around 15 years before becoming relatively sane. It was pretty OK for the industry; ~we are different from them now, and they are not that crazy~. Or maybe they are and we will become a bit later.
