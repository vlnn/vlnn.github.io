...
Traditionally you would search for a good textbook, where good means "accessible enough" and "precise enough" at the same time: in complex areas it's easy to stay at the [wrong level of abstraction](wrong-level-of-abstraction.md). It's a hard problem, easily leading to yak shaving or canceling the project.

LLMs hit twice in that area:
* they generate complex long stuff (imagine vibecoded project)
* they simplify long stuff into short stuff quickly ("ELI5 the document" prompt works really good with modern models)
...
This is similar to [Bruner's spiral curriculum](bruner-s-spiral-curriculum.md), but customized to the field of interest. It also reminds of Vygotsky's [zone of proximal development,](zone-of-proximal-development.md) but with textual aid instead of teacher figure. It's very similar to [Elaborative sequencing](elaborative-sequencing.md) of [Elaboration Theory](elaboration-theory.md). Also related to the [Feynman technique](feynman-technique.md). Also related to Korean study methodology  [단권화 Single Book Summary](single-book-summary.md)

## Related

- [Feynman technique](feynman-technique.md)
- [Bruner's spiral curriculum](bruner-s-spiral-curriculum.md)
- [단권화 Single Book Summary](single-book-summary.md)
