...
"Evergreenness" of those notes is never explained, but my current understanding is that they have to be abstract enough to be referred to in different contexts. So for instance I can mention [knowledge work](knowledge-work.md) and this is useful but not really evergreen: it's merely a reference. But I can mention that [Evergreen notes should be concept-oriented](evergreen-notes-should-be-concept-oriented.md), and this is main functional difference from other kinds of notes: I can simply use the concept description in my line of thought in any context. 

Not all notes here are evergreen for sure. This is rather spectrum quality that makes one notes more useful in the [digital garden](digital-garden.md),
