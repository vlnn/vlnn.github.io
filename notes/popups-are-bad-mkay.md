...
- duplication of the information as in `duplication of the information` because the \`information being duplicated\` and my brain hates it. I guess you understand how duplicated the information can become and how hateful it is. See how same info is in the popup and in the status line: <file:static/popup.png>
- hiding of things I was just reading, and now I suddenly can't anymore, just because I was courageous enough to move the cursor over the <u>text I'm fucking trying to read</u>: <file:static/popup2.png>
