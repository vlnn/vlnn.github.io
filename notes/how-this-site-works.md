...
It's nice to have all the textual stuff as files -- until you want to interconnect it. For that reason I wrote a [TheBrain](TheBrain) **brz** files into **md** [converter](a2b_converter). 
